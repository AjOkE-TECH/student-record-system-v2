...
if (isset($_POST['add_course'])) {
    ...
    if ($course_code == "" || $course_title == "") {
        ...
        if (!$session_check || mysqli_num_rows($session_check) == 0) {
            ...
            /* Duplicate check (same code + session) */
            ...
            if ($dup_check && mysqli_num_rows($dup_check) > 0) {
                ...
                $error = "A course with this code already exists for the selected session.";
                ...
                $insert = mysqli_query(
                    $conn,
                    "INSERT INTO courses
                     (course_code, course_title, session_id)
                     VALUES
                     ('$code_escaped', '$title_escaped', $session_id)"
                );
                ...
                if ($insert) {
                    ...
                    $error = "Unable to save course: " . mysqli_error($conn);
...
<head>
    ...
    <title>
        Add Course - Student Record Management System
    </title>
            ...
            <div class="course-page">
                ...
                <div class="course-page-header">
                    ...
                    <div>
                        ...
                        <p>
                            Add a course offering for a specific academic session.
                        </p>
